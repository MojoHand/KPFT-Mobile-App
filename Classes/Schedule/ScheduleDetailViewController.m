...
- (void)loadView 
{
	...
	UIWebView *webView = [[UIWebView alloc] initWithFrame:CGRectMake(4, titleLabel.frame.size.height + 42, 312, 480 - (titleLabel.frame.size.height + 216))];
...
{
	if ([SettingsSupport isOpenInSafari]) 
	{
		[[UIApplication sharedApplication] openURL:[NSURL URLWithString:[self.detailDictionary valueForKey:@"link"]]];
	} 
	else 
	{
